...
config: dict[str, Any] = {
    "DEFAULT": {
        ...
        # Header to add above Dolby Vision/HDR10+ metadata plots.
    ...
    "TRACKERS": {
        ...
        # Available tracker: 1PTBA, ASIANCINEMA, AITHER, ANTHELION, ALPHARATIO, AMIGOSSHARE, AVISTAZ, BEYONDHD, BITHDTV, BITPORN, BJSHARE, BLUTOPIA, BRASILTRACKER, BROADCASTHENET, CAPYBARABR, CURUPIRA, SUIO, CINEMAZ, DIGITALCORE, DRUNKENSLUG, DARKPEERS, DESITORRENTS, DREADVAULT, EMUWAREZ, FUNFILE, FILELIST, FLOOD,
