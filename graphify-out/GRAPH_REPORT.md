...
Cohesion: 0.06
Nodes (42): autofill_missing_keys(), configure_default_section(), configure_single_client(), configure_torrent_clients(), configure_trackers(), find_missing_keys(), generate_config_file(), get_img_host() (+34 more)
...
Cohesion: 0.11
Nodes (34): _apply_music_cli_overrides(), _discogs_ids(), enrich_music_from_discogs(), enrich_music_from_orpheus(), _extract_embedded_artwork(), _find_discogs_release(), gather_music_prep(), _image_suffix() (+26 more)
...
Cohesion: 0.06
Nodes (6): argumentCategories, AudionutsUAGUI(), mediaIconForCategory(), metadataProviderIcons, metadataProviderStyles, root
...
Cohesion: 0.11
Nodes (13): DEFAULT, Torrent Clients, Trackers, Basic commands, Create the configuration, Install with the `.exe`, Windows Installation, **Attributions:** (+5 more)
...
Cohesion: 0.11
Nodes (19): Anonymity / seeding / streaming flags, Argument-Embedded Text Queue (.txt), Basic usage, Cleanup / temp directory, Debugging / output, Description inputs, Help output, Modes / workflows (+11 more)

### Community 112 - "Community 112"
Cohesion: 0.11
Nodes (19): `DEFAULT` section, Description extras, Description formatting hooks, HDR tonemapping, Image host credentials, Image host selection (priority list), Logging / output, Metadata APIs (+11 more)
...
Cohesion: 0.29
Nodes (4): LanguagesManager, Any, Check if any language in the list contains 'english, Extract language from title field using langcodes library
...
Cohesion: 0.17
Nodes (11): Can I use this with Docker on Windows?, Can I utilize the -vs/--vapoursynth parameter?, Config-generator, How do I update the docker image?, How do I use an image of a specific commit?, Supported Architectures, The command for running is really long and I dont want to type it., Usage? (+3 more)
...
Cohesion: 0.29
Nodes (7): Deluge, qBittorrent (`torrent_client: "qbit"`), ruTorrent / rTorrent, `TORRENT_CLIENTS` section, Tracker overridable settings, Transmission, Watch folder
