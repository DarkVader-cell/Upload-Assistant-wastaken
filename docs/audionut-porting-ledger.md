...
| T-05 | MTV timeout and upload fixes | `src/trackers/MTV.py`, commits `70d1ace9`, `11cb5366` | removed upstream in v3.4 | `not applicable` | MoreThanTV support was removed upstream in v3.4 and is no longer part of this fork. |
