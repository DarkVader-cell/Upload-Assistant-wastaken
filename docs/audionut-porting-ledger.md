...
| M-06 | Anime recognition and duplicate-size tolerance | `src/tmdb.py`, `src/dupe_checking.py`, `src/trackers/ULCX.py` | tracker and metadata modules | `review` | Compare behavior and configuration defaults; test opt-in tolerance and MAL/manual anime paths. |
