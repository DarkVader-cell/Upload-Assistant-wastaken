...
| M-11 | DT Indian-language audio gate | `src/trackers/DT.py`, commits `3df90b9e`, `0ca8a461` | Wastaken tracker set | `excluded` | Wastaken has no DT tracker module or upload path. The reusable language aliases were ported separately in M-03; do not add an unused DT gate. |
